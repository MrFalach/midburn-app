...
function isSlotPlaying(
  ...
  if (endTimeInMinutes < startTimeInMinutes) {
    ...
    if (currentTimeInMinutes < 720) {
      return (
        currentTimeInMinutes + 24 * 60 >= startTimeInMinutes &&
        currentTimeInMinutes + 24 * 60 < endTimeInMinutes
      );
    }
  }
  ...
  return (
    <div className="rounded-2xl overflow-hidden vintage-shadow burned-edges">
      ...
      >
        ...
        <h2
          className="text-2xl font-bold text-center text-amber-100 flex items-center justify-center gap-2 relative z-10"
