...
export function LiveNowView({ liveSlots }: LiveNowViewProps) {
  if (liveSlots.length === 0) {
    return (
      <div
        className="rounded-2xl vintage-shadow burned-edges p-8 text-center relative mx-6"
        style={{
          background: "#f59e0b",
          backgroundImage: `
      ...
      >
        ...
        <p className="text-orange-950 text-lg font-semibold">
          אין כרגע הופעות בזמן אמת
        </p>
      </div>
    );
  }
